  ...
  if (!verified) return (
    <div style={{ minHeight:'100vh', backgroundColor:'#f5f5f7', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:'-apple-system, BlinkMacSystemFont, SF Pro Display, sans-serif', padding:'2rem' }}>
      <div style={{ backgroundColor:'#fff', borderRadius:'1.5rem', padding:'3rem', maxWidth:'480px', width:'100%', textAlign:'center', boxShadow:'0 4px 24px rgba(0,0,0,0.08)' }}>
        ...
        <p style={{ color:'#6e6e73', lineHeight:'1.7', marginBottom:'2rem' }}>You must verify your identity before booking a drone session. This keeps our platform safe and compliant with FAA requirements.</p>
  ...
  if (success) return (
    <div style={{ minHeight:'100vh', backgroundColor:'#f5f5f7', display:'flex', alignItems:'center', justifyContent:'center', fontFamily:'-apple-system, BlinkMacSystemFont, SF Pro Display, sans-serif', padding:'2rem' }}>
      <div style={{ backgroundColor:'#fff', borderRadius:'1.5rem', padding:'3rem', maxWidth:'480px', width:'100%', textAlign:'center', boxShadow:'0 4px 24px rgba(0,0,0,0.08)' }}>
        ...
        <p style={{ color:'#6e6e73', lineHeight:'1.7', marginBottom:'2rem' }}>Your mission request has been submitted. A verified pilot near {zoneName} will accept your mission. You'll be notified when they take off.</p>
  ...
  return (
    <div style={{ minHeight:'100vh', backgroundColor:'#f5f5f7', fontFamily:'-apple-system, BlinkMacSystemFont, SF Pro Display, sans-serif', padding:'2rem' }}>
      <div style={{ maxWidth:'580px', margin:'0 auto' }}>
        ...
        {step === 1 && (
          <div style={{ backgroundColor:'#fff', borderRadius:'1.25rem', padding:'2rem', border:'1px solid rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ backgroundColor:'#fff2f2', border:'1px solid #fecaca', borderRadius:'0.75rem', padding:'1rem', marginBottom:'1.5rem' }}>
              <p style={{ fontSize:'0.82rem', color:'#dc2626', fontWeight:'600' }}>⚠️ All answers are reviewed by our Trust & Safety team. False declarations result in immediate account termination and may be reported to law enforcement.</p>
            </div>
            {SAFETY_QUESTIONS.map(q => (
              <div key={q.key} style={{ display:'flex', alignItems:'flex-start', gap:'0.875rem', marginBottom:'1rem', padding:'1rem', backgroundColor:'#f5f5f7', borderRadius:'0.75rem', border:'1px solid '+(answers[q.key]?'#a7f3d0':'rgba(0,0,0,0.06)') }}>
                ...
                <p style={{ fontSize:'0.85rem', color:'#1d1d1f', lineHeight:'1.5' }}>{q.q}</p>
              </div>
            ))}
        ...
        {step === 2 && (
          <div style={{ backgroundColor:'#fff', borderRadius:'1.25rem', padding:'2rem', border:'1px solid rgba(0,0,0,0.07)' }}>
            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'1rem' }}>
              ...
              <div>
                <label style={{ display:'block', fontSize:'0.82rem', fontWeight:'600', color:'#1d1d1f', marginBottom:'0.4rem' }}>Preferred Date & Time</label>
              ...
              <div>
                <label style={{ display:'block', fontSize:'0.82rem', fontWeight:'600', color:'#1d1d1f', marginBottom:'0.4rem' }}>Duration: {form.durationMinutes} minutes (${form.durationMinutes}.00 estimated)</label>
                ...
                <div style={{ display:'flex', justifyContent:'space-between', fontSize:'0.72rem', color:'#6e6e73' }}><span>15 min ($15)</span><span>120 min ($120)</span></div>
              </div>
            </div>
            <div style={{ display:'flex', gap:'0.75rem', marginTop:'1.5rem' }}>
              ...
              <button onClick={() => setStep(3)} disabled={!form.purpose || !form.description} style={{ flex:2, backgroundColor:'#6366f1', color:'#fff', border:'none', borderRadius:'980px', padding:'0.875rem', fontSize:'0.875rem', fontWeight:'600', cursor:'pointer', opacity:!form.purpose||!form.description?0.5:1, fontFamily:'inherit' }}>Review & Confirm →</button>
            </div>
          </div>
        )}
        ...
        {step === 3 && (
          <div style={{ backgroundColor:'#fff', borderRadius:'1.25rem', padding:'2rem', border:'1px solid rgba(0,0,0,0.07)' }}>
            <h2 style={{ fontWeight:'700', fontSize:'1.1rem', color:'#1d1d1f', marginBottom:'1.5rem' }}>Step 3: Review & Confirm</h2>
            ...
            <div style={{ backgroundColor:'#fffbeb', border:'1px solid #fde68a', borderRadius:'0.75rem', padding:'0.875rem', marginBottom:'1.5rem' }}>
              <p style={{ fontSize:'0.8rem', color:'#92400e' }}>💳 A $30 pre-authorization will be placed on your card. You are only charged for actual flight time.</p>
            </div>
